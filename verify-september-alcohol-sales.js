...
async function verifySeptemberAlcoholSales() {
  ...
  try {
    ...
    console.log("\n🔍 Verifying September 2025 alcohol sales...");
    ...
    if (overallStats.length > 0) {
      ...
      console.log(`\n📊 September 2025 Alcohol Sales Summary:`);
    ...
    dailyStats.forEach((day) => {
      ...
      console.log(
        `Sep ${day._id.toString().padStart(2, "0")} (${dayName}): ${
          day.count
    ...
    console.log(`\n✅ September 2025 alcohol sales verification completed!`);
  } catch (error) {
    console.error("Error verifying September alcohol sales:", error);
  } finally {
    await client.close();
    console.log("\nConnection closed");
  }
