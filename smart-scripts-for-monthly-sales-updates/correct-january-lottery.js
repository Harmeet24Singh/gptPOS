...
async function correctJanuaryLottery() {
    ...
    try {
        ...
        for (const transaction of lotteryTransactions) {
            ...
            if (toDelete.length >= Math.ceil(excessAmount / (currentTotal / currentCount))) {
                break;
            }
        }
        ...
        console.log(`🎯 Final amount will be: $${(currentTotal - deletedAmount).toFixed(2)}`);
        ...
        console.log(`🎯 Target achievement: ${(finalTotal/targetAmount*100).toFixed(1)}%`);
