...
function POSContent() {
  ...
  const [userIsTyping, setUserIsTyping] = useState(false); // Prevent auto-updates while user types
  ...
  }, [userIsTyping, cashAmount, cardAmount, lottoWinnings]);
                ...
                <OnScreenKeyboard
                  ...
                  onKeyPress={(key) => {
                    ...
                    console.log("🔍 activeInputRef at key press:", {
                      activeInputRef,
                      activeInputRefCurrent: activeInputRef?.current,
                      activeInputRefCurrentValue:
                        activeInputRef?.current?.value,
                    });
                  }}
                />
                  ...
                  <>
                    ...
                    >
                      ...
                      <input
                        ...
                        onFocus={() =>
                          handleInputFocus(cashbackAmountRef, true)
                        }
                        onChange={(e) => {
