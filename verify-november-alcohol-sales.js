...
async function verifyNovemberAlcoholSales() {
  ...
  try {
    ...
    console.log("\n🔍 Verifying November 2025 alcohol sales...");
    ...
    if (overallStats.length > 0) {
      ...
      console.log(`\n📊 November 2025 Alcohol Sales Summary:`);
    ...
    console.log(`\n✅ November 2025 alcohol sales verification completed!`);
  } catch (error) {
    console.error("Error verifying November alcohol sales:", error);
  } finally {
    await client.close();
    console.log("\nConnection closed");
  }
