...
console.log("Month end string:", `${nextYear}-${nextMonth.toString().padStart(2, "0")}-01T00:00:00.000Z`);
...
console.log("Is sample in range?", sampleTimestamp >= monthStart && sampleTimestamp < monthEnd);