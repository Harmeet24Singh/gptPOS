...
async function checkJanuaryLottery() {
  ...
  try {
    ...
    if (lotteryResults[0]) {
      console.log(
        `💰 Item-level calculation: $${lotteryResults[0].totalAmount.toFixed(2)}`,
      );
      console.log(
        `📝 Lottery transactions: ${lotteryResults[0].transactionCount}`,
      );
    } else {
    ...
    if (transactionTotals[0]) {
      console.log(
        `💰 Transaction-level total: $${transactionTotals[0].totalAmount.toFixed(2)}`,
      );
      console.log(
        `📝 Transaction count: ${transactionTotals[0].transactionCount}`,
      );
    } else {
