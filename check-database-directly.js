...
async function checkDatabaseDirectly() {
  ...
  try {
    ...
    console.log(
      `   Total October transactions in DB: ${octoberTransactions.length}`,
    );

    // Calculate total
    const totalSales = octoberTransactions.reduce(
    ...
    console.log(
      `   Unique transaction IDs: ${Object.keys(transactionIds).length}`,
    );
